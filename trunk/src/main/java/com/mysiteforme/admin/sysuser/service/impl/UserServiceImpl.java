...
import com.mysiteforme.admin.sysuser.dao.UserDao;
import com.mysiteforme.admin.sysuser.entity.Role;
import com.mysiteforme.admin.sysuser.entity.User;
import com.mysiteforme.admin.sysuser.service.UserService;
...
public class UserServiceImpl extends ServiceImpl<UserDao, User> implements UserService {
	...
	@Caching(put = {
			...
			@CachePut(value = "user", key = "'user_wechat_id_'+#user.tel", condition = "#user.tel != null and #user.tel != ''")
	})
